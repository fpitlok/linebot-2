 ...
 */
  ...
  class db
  {
    ...
    public $server = 'lbt.psru.ac.th';
    public $username = 'ubru';
    public $password = 'ubru';
    public $dbname = 'ubru';
    ...
    public function __construct ()
    {
      ...
      $this->conn = new \mysqli($this->server, $this->username, $this->password, $this->dbname, 0, '/var/run/mysqld/mysqld.sock');
